...
class halaman_buat_surat_izin_keluar_siswa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inisialisasi View
        etJudul = findViewById(R.id.et_judul_keterangan) // Menggunakan Judul Keterangan
        ...
        // Logika DatePicker (Format MySQL YYYY-MM-DD)
    ...
    private fun kirimDataKeServer() {
        ...
        RetrofitClient.instance.buatSuratIzinKeluar(token, request).enqueue(object : Callback<GeneralResponse> {
            override fun onResponse(call: Call<GeneralResponse>, response: Response<GeneralResponse>) {
                if (response.isSuccessful) {
                    tampilkanDialogBerhasil()
                } else {
                    Toast.makeText(this@halaman_buat_surat_izin_keluar_siswa, "Gagal membuat surat.", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onFailure(call: Call<GeneralResponse>, t: Throwable) {
                Toast.makeText(this@halaman_buat_surat_izin_keluar_siswa, "Koneksi bermasalah: ${t.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun muatDataKonsentrasiKeahlian() {
        ...
        val adapterSementara = ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, listOf("-- Memuat Data... --"))
        spinnerKeahlian.adapter = adapterSementara
            ...
            override fun onResponse(call: Call<List<DepartmentResponse>>, response: Response<List<DepartmentResponse>>) {
                if (response.isSuccessful && response.body() != null) {
                    ...
                    val adapter = ArrayAdapter(
                        this@halaman_buat_surat_izin_keluar_siswa,
