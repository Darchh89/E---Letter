...
class halaman_lihat_surat_dispensasi_siswa : AppCompatActivity() {
    ...
    // Perhatikan nomor suratnya menggunakan SRT-DSP
    private val daftarSurat = listOf(
        SuratDummy(R.id.item_surat_1, "Menunggu", "SRT-DSP-005"),
        SuratDummy(R.id.item_surat_2, "Menunggu", "SRT-DSP-004"),
        SuratDummy(R.id.item_surat_3, "Menunggu", "SRT-DSP-003"),
        SuratDummy(R.id.item_surat_4, "Disetujui", "SRT-DSP-002"),
        SuratDummy(R.id.item_surat_5, "Ditolak", "SRT-DSP-001")
    )
